...
export interface UseAuthReturn {
  ...
  updateAccountBalance: (accountId: string, balance: string) => void;
  error: string | null;
}
...
export function useAuth(): UseAuthReturn {
  ...
  // Live balance update — called by use-balance when the WS balance stream fires
  const updateAccountBalance = useCallback((accountId: string, balance: string) => {
    setAccounts(prev =>
